...
const AboutMe = () => {
  ...
  const handleCV =() => {
    window.open('https://drive.google.com/file/d/1mk_XnwaPuyUZGqTtBDpnOhJpb4dAyEPd/view?usp=sharing', 
                '_blank')
  }
  return (
